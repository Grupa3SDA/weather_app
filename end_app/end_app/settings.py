"""
Django settings for end_app project.
...
ALLOWED_HOSTS = ['weatherapp.eu', 'localhost', '127.0.0.1']  # Localhost urls
...
WSGI_APPLICATION = "end_app.wsgi.application"
